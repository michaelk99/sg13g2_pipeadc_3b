...
A 4 887.5 -680 7.071067811865476 315 360 {}
A 4 887.5 -570 7.071067811865476 315 360 {}
T {E} 680 -690 0 0 0.2 0.2 {}
T {E} 680 -580 0 0 0.2 0.2 {}
N 400 -440 450 -440 {lab=vss}
N 450 -440 450 -280 {lab=vss}
...
N 560 -520 780 -520 {lab=CLK_REG}
N 780 -570 780 -520 {lab=CLK_REG}
N 780 -680 800 -680 {lab=CLK_REG}
N 780 -570 800 -570 {lab=CLK_REG}
N 780 -680 780 -570 {lab=CLK_REG}
...
C {iopin.sym} 120 -280 0 1 {name=p1 lab=vss}
C {netlist_at_end.sym} 600 -330 0 0 {name=DFF only_toplevel=false value="
a31 Q_REG0 CLK_REG NULL NULL %d(Q0 NQ0) dff1
a32 Q_REG1 CLK_REG NULL NULL %d(Q1 NQ1) dff1
"}
...
C {netlist_at_end.sym} 1160 -330 0 0 {name=DFFBYPASS only_toplevel=false value="
a211 D0 NQ0 inv1
a212 NQ0 Q0 inv1
a221 D1 NQ1 inv1
a222 NQ1 Q1 inv1
"
spice_ignore=true}
C {netlist_at_end.sym} 600 -450 0 0 {name=DLATCH only_toplevel=false value="
a21 D0 CLK NULL NULL %d(Q_REG0 NQ_REG0) dlatch1
a22 D1 CLK NULL NULL %d(Q_REG1 NQ_REG1) dlatch1
"
}
C {ipin.sym} 120 -320 0 0 {name=p20 lab=vclk_reg}
C {lab_wire.sym} 330 -320 0 0 {name=p21 sig_type=std_logic lab=CLK_REG}
C {devices/adc_bridge.sym} 190 -320 0 0 {name=A5 adc_bridge_model= adc_buf}
