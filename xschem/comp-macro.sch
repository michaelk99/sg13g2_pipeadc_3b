...
N 620 -440 680 -440 {
lab=#net1}
N 740 -440 810 -440 {lab=do}
N 620 -440 620 -420 {lab=#net1}
N 620 -360 620 -320 {lab=#net2}
...
C {netlist_at_end.sym} 30 -90 0 0 {name=MODEL only_toplevel=false value=".model comp0 adc_bridge(in_low=-0.0001 in_high=0.0001)"}
...
C {opin.sym} 810 -440 0 0 {name=p7 lab=do}
