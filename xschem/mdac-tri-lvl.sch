...
N 1460 -440 1530 -440 {lab=vo_p}
N 1170 -350 1190 -350 {lab=vbp}
N 890 -370 970 -370 {lab=vgndp}
N 1190 -230 1310 -230 {lab=vbp}
N 1440 -290 1460 -290 {lab=vo_p}
N 1170 -370 1480 -370 {lab=vfb}
N 1440 -260 1480 -260 {lab=vfb}
N 1440 -230 1500 -230 {lab=vo_n}
N 1500 -400 1530 -400 {lab=vo_n}
N 1440 -440 1460 -440 {lab=vo_p}
N 1400 -400 1500 -400 {lab=vo_n}
N 1170 -440 1240 -440 {lab=vo_p}
N 1170 -400 1340 -400 {lab=vo_n}
N 910 -570 1240 -570 {lab=vgndn}
...
N 430 -200 620 -200 {lab=vdac_n}
N 430 -450 620 -450 {lab=vdac_p}
...
N 1190 -350 1190 -230 {lab=vbp}
N 1460 -440 1460 -290 {lab=vo_p}
N 1480 -370 1480 -260 {lab=vfb}
N 1500 -400 1500 -230 {lab=vo_n}
...
bus=true}
N 580 -540 620 -540 {lab=vsample}
N 440 -580 440 -540 {lab=vsample}
N 200 -580 440 -580 {lab=vsample}
N 580 -410 620 -410 {lab=vsample}
N 580 -540 580 -410 {lab=vsample}
N 440 -540 580 -540 {lab=vsample}
N 580 -280 620 -280 {lab=vsample}
N 580 -410 580 -280 {lab=vsample}
N 580 -160 620 -160 {lab=vsample}
N 580 -280 580 -160 {lab=vsample}
N 600 -600 620 -600 {lab=vmult}
N 600 -470 620 -470 {lab=vmult}
N 600 -600 600 -470 {lab=vmult}
N 420 -600 600 -600 {lab=vmult}
N 600 -340 620 -340 {lab=vmult}
N 600 -470 600 -340 {lab=vmult}
N 600 -220 620 -220 {lab=vmult}
N 600 -340 600 -220 {lab=vmult}
N 1360 -350 1360 -320 {lab=vsample}
N 1390 -350 1390 -320 {lab=vmult}
N 200 -740 1070 -740 {lab=vdd_1v5}
...
N 440 -630 440 -580 {lab=vsample}
N 440 -630 1280 -630 {lab=vsample}
N 1280 -630 1280 -510 {lab=vsample}
N 1300 -630 1380 -630 {lab=vsample}
N 1380 -630 1380 -510 {lab=vsample}
N 1300 -630 1300 -350 {lab=vsample}
N 1300 -350 1360 -350 {lab=vsample}
N 1280 -630 1300 -630 {lab=vsample}
N 1400 -680 1400 -400 {lab=vo_n}
N 1440 -700 1440 -440 {lab=vo_p}
N 420 -660 420 -600 {lab=vmult}
N 420 -660 1420 -660 {lab=vmult}
N 200 -600 420 -600 {lab=vmult}
N 1420 -660 1420 -350 {lab=vmult}
N 1390 -350 1420 -350 {lab=vmult}
N 200 -120 1110 -120 {lab=di_ena}
N 1280 -100 1380 -100 {lab=vss}
N 450 -100 770 -100 {lab=vss}
N 200 -100 450 -100 {lab=vss}
N 770 -280 770 -160 {lab=vss}
N 450 -420 450 -170 {lab=vss}
N 1070 -340 1070 -100 {lab=vss}
N 770 -100 1070 -100 {lab=vss}
N 1380 -200 1380 -100 {lab=vss}
...
device_model=".MODEL SW1 SW( VT=0.75 VH=0.01 RON=1 ROFF=1G )"}
C {sw_cap.sym} 620 -610 0 0 {name=xc1 cap=100f ron=1 roff=1G
}
...
C {ipin.sym} 200 -580 0 0 {name=p16 lab=vsample}
C {ipin.sym} 200 -600 0 0 {name=p17 lab=vmult}
C {lab_wire.sym} 290 -510 0 0 {name=p24 sig_type=std_logic lab=di_code[2:0]}
C {lab_wire.sym} 1390 -350 0 1 {name=p11 sig_type=std_logic lab=vmult}
C {lab_wire.sym} 1360 -350 0 0 {name=p20 sig_type=std_logic lab=vsample}
C {lab_wire.sym} 1280 -580 3 0 {name=p21 sig_type=std_logic lab=vsample}
C {lab_wire.sym} 1380 -580 3 0 {name=p22 sig_type=std_logic lab=vsample}
C {lab_wire.sym} 520 -450 0 0 {name=p18 sig_type=std_logic lab=vdac_p}
C {lab_wire.sym} 520 -200 0 0 {name=p19 sig_type=std_logic lab=vdac_n}
C {lab_wire.sym} 1220 -230 0 0 {name=p23 sig_type=std_logic lab=vbp}
C {lab_wire.sym} 1220 -370 0 0 {name=p25 sig_type=std_logic lab=vfb}
