...
bus=true}
N 540 -500 750 -500 {lab=di_code[2]}
N 750 -500 750 -460 {lab=di_code[2]}
N 540 -370 750 -370 {lab=di_code[1]}
N 750 -370 750 -330 {lab=di_code[1]}
N 540 -250 750 -250 {lab=di_code[0]}
N 750 -250 750 -200 {lab=di_code[0]}
...
C {lab_wire.sym} 640 -500 0 0 {name=p7 sig_type=std_logic lab=di_code[2]}
C {lab_wire.sym} 640 -370 0 0 {name=p8 sig_type=std_logic lab=di_code[1]}
C {lab_wire.sym} 660 -250 0 0 {name=p9 sig_type=std_logic lab=di_code[0]}
